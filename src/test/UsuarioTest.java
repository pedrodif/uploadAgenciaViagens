...
public class UsuarioTest {
    ...
    public void testSetEmail() {
        ...
        assertFalse(result);
        assertNotEquals("thiago.com", usuario.getEmail());
    }
    ...
    public void testLoginComSucesso() {
        Usuario usuario1 = new Usuario("Thyago", "123.456.789-00", "thyago@email.com", "usuario123", "senha123");
        Usuario.MOCK_USUARIOS.add(usuario1);

        Usuario resultado = usuario.login("thyago@email.com", "senha123");
